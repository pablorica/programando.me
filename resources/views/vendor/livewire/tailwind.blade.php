<div>
    @if ($paginator->hasPages())
        ...
        <div class="bg-white min-w-0 flex-1 px-4 py-3 mb-5 sm:px-6">
                                    ...
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-{{ $this->numberOfPaginatorsRendered[$paginator->getPageName()] }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium z-10 bg-indigo-50 border border-indigo-500 text-indigo-600 cursor-default leading-5 select-none">{{ $page }}</span>
                                            </span>
                                        @else
